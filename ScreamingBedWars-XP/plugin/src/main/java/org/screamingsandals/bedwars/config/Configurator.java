...
public class Configurator {
    ...
    public void createFiles() {
        ...
        checkOrSetConfig(modify, "resources", new HashMap<String, Object>() {
            {
                put("copper", new HashMap<String, Object>() {
                    {
                        put("material", "COPPER_INGOT");
                        /* Config migration 1 -> 2: if spawners.copper exists, get this value */
                        put("interval", 1);
                        put("name", "Copper");
                        put("translate", "resource_copper");
                        put("color", "GOLD");
                        put("spread", 1.0);
                    }
                });
                ...
                put("diamond", new HashMap<String, Object>() {
                    {
                        put("material", "DIAMOND");
                        /* Config migration 1 -> 2: if spawners.diamond exists, get this value */
                        put("interval", 20);
                        put("name", "Diamond");
                        put("translate", "resource_diamond");
                        put("spread", 1.0);
                    }
                });
                put("emerald", new HashMap<String, Object>() {
                    {
                        ...
                        /* Config migration 1 -> 2: if spawners.emerald exists, get this value */
                        put("interval", config.getInt("spawners.emerald", 30));
                        put("name", "Emerald");
        ...
        checkOrSetConfig(modify, "economy-rates", new HashMap<String, Object>() {
            {
                put("copper", 2.0);
                put("iron", 5.0);
                put("gold", 10.0);
